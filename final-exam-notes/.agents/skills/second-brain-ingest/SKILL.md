...
Use Bash to stage and commit the new and updated wiki files. Do not commit changes to the `output/` directory.

1. Run `git add wiki/` 
2. Run `git commit -m "ingest: [Source Title]"`
3. Run `git push` to push changes to remote
